...
<template>
 <div>
    <div v-if="liste_selection_essences.length > 0"  style="display: flex; flex-direction: column; width: 30%;" > 

      <div v-for="(item_type_degat, index_type_degat) of nomenclature.OEASC_DEGAT_TYPE.values" :key="item_type_degat.id_nomenclature">
          ...
          <div style="position: relative; display: inline-block">
            <v-checkbox
              ...
              :hide-details="index_type_degat < nomenclature.OEASC_DEGAT_TYPE.values.length - 1 ? true : false"
              :value="item_type_degat.id_nomenclature"
              :label="item_type_degat.label_fr"
              dense
              :rules="[v => SelecteddegatTypesComputed.length > 0 || 'Veuillez sélectionner au moins un type de dégât']"
            >
            ...
            <!-- -----------------  affichage des degats déja enregisté ------------------------ -->
              ...
              <div v-if="SelecteddegatTypesComputed.includes(item_type_degat.id_nomenclature)" style="margin-left:50px;">
                <v-simple-table style="width: 900px;">
                  ...
                  <thead v-if="item_type_degat.cd_nomenclature !== 'P/C' && item_type_degat.cd_nomenclature !== 'ABS'">
                    <tr>
                      <th>Essence</th>
                      <th>Gravité</th>
                      <th>Étendue</th>
                  ...
                  <thead v-else-if="item_type_degat.cd_nomenclature === 'P/C'">
                  </thead>
                  ...
                  <tbody>
                    ...
                    <tr v-for="(item_degat_essence, index_degat_essence) of get_degat_declaration_from_id_nomenclature(item_type_degat.id_nomenclature).degat_essences" :key="index_degat_essence">

                      <th v-if="item_type_degat.cd_nomenclature !== 'P/C'">
                        <!-- si l'essence est selectionnée dans la liste des essences du peuplement -->
                        <span v-if="liste_selection_essences.includes(item_degat_essence.id_nomenclature_degat_essence) && item_type_degat.cd_nomenclature !== 'P/C'">
                          {{ get_nomenclature_degat_of_declaration(item_type_degat.id_nomenclature, index_degat_essence, "id_nomenclature_degat_essence", 'OEASC_PEUPLEMENT_ESSENCE').label_fr }}
                        </span>
                      ...
                      <th v-if="item_type_degat.cd_nomenclature !== 'P/C' && item_type_degat.cd_nomenclature !== 'ABS'">
                        {{ get_nomenclature_degat_of_declaration(item_type_degat.id_nomenclature, index_degat_essence,  "id_nomenclature_degat_gravite", 'OEASC_DEGAT_GRAVITE').label_fr }}
                      </th>
                      <th v-if="item_type_degat.cd_nomenclature !== 'P/C' && item_type_degat.cd_nomenclature !== 'ABS'">
                        {{ get_nomenclature_degat_of_declaration(item_type_degat.id_nomenclature, index_degat_essence, "id_nomenclature_degat_etendue", 'OEASC_DEGAT_ETENDUE').label_fr }}
                      </th>
                      <th v-if="item_type_degat.cd_nomenclature !== 'P/C' && item_type_degat.cd_nomenclature !== 'ABS'">
                        {{ get_nomenclature_degat_of_declaration(item_type_degat.id_nomenclature, index_degat_essence, "id_nomenclature_degat_anteriorite", 'OEASC_DEGAT_ANTERIORITE').label_fr }}
                      </th>
                      ...
                      <th v-if="item_type_degat.cd_nomenclature !== 'P/C'">
                        <v-btn
                          icon
                          @click="removeDegatEssence(item_type_degat.id_nomenclature, item_degat_essence.id_nomenclature_degat_essence)"
                        >
                    ...
                    <tr v-if="condition_affichage_mini_formulaire_degat(item_type_degat)">
                        ...
                        <th v-if="item_type_degat.cd_nomenclature !== 'P/C'">
                            ...
                            <v-select
                              ...
                              :items="nomenclature.OEASC_PEUPLEMENT_ESSENCE.values.filter(e =>
                                liste_selection_essences.includes(e.id_nomenclature) &&
                                !get_degat_declaration_from_id_nomenclature(item_type_degat.id_nomenclature)
                                  .degat_essences.some(de => de.id_nomenclature_degat_essence === e.id_nomenclature)
                              )"
                  ...
                  <tfoot v-if="item_type_degat.cd_nomenclature !== 'P/C' && condition_affichage_btn_add_degat_essence(item_type_degat)">
                    <tr>
                      <td colspan="5">
                        <v-btn
          ...
          </div> <!-- fin de div des checkbox -->

      </div> <!-- fin de la boucle des types de dégâts -->

    </div>
    <div v-else>
      <p>Pour déclarer des dégâts, veuillez d'abord sélectionner des essences dans l'encart précédent</p>
    </div>
...
export default {
  ...
  methods: { 
    ...
    condition_affichage_mini_formulaire_degat(item_type_degat) {
      const degat = this.declaration_data.degats.find( d => 
     ...
     */
    get_nomenclature_degat_of_declaration(id_degat_type, index_essence, key_nomenclature, type_nomenclature) {
      const degat = this.declaration_data.degats.find(
    ...
    cancelDegatEssence(id_nomenclature_degat_type) {
      ...
      this.degatTypes = this.declaration_data.degats.map(
    ...
    get_essence_of_degat_from_declaration( id_nomenclature_degat_type, id_nomenclature_degat_essence){
      const degat = this.get_degat_declaration_from_id_nomenclature(
        id_nomenclature_degat_type
      );
      if (degat) {
