  ...
  <div>
    ...
    <div>
      <v-row>
        ...
        >
          <v-card>
            <v-card-title class="headline">Envoi de votre déclaration</v-card-title>
            ...
            <v-card-text>
              Veuillez patienter, le processus peut prendre quelques instants.
            </v-card-text>
          </v-card>
        </v-dialog>
        <v-dialog
          v-model="bModalSuccess"
          persistent
          max-width="600"
        >
          <v-card>
