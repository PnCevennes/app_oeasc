  ...
  <div>
    ...
    >
      <div slot="success">
        ...
        <p>
          Il est possible que celui-ci ait été placé par votre boite mail dans votre dossier "spam"
          ou "courrier indésirable". Pensez donc à vérifier celui-ci si vous ne trouvez pas notre
          e-mail dans votre boîte de réception habituelle.
        </p>
        <p>
          Veuillez cliquer sur le lien de confirmation présent dans cet e-mail afin de procéder au
      ...
      <div slot="prependForm">
        <div>
          <p>
            Entrez votre identifiant (e-mail utilisé pour la création du compte) et appuyez sur
    ...
    <generic-form
      :config="computedConfigFormPassword"
      ref="form"
      v-if="token"
    >
      <div slot="success">
