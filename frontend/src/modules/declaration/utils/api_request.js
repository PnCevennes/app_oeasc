...
export async function  fetch_oeasc_perimetre() {
    try {
        const response = await apiRequest("GET", `api/ref_geo/areas_simples_from_type_code/l/OEASC_PERIMETRE`);
        return response;
    } catch (error) {
...
export async function  fetch_all_foret_onf() {
    try {
        const response = await apiRequest("GET", `api/ref_geo/areas_simples_from_type_code/l/OEASC_ONF_FRT`);
        return response;
    } catch (error) {
        console.error("Erreur lors de la récupération des forêts par code", error);
        return null;
...
export async function  fetch_all_foret_dgd() {
    try {
        const response = await apiRequest("GET", `api/ref_geo/areas_simples_from_type_code/l/OEASC_DGD`);
        return response;
    } catch (error) {
        console.error("Erreur lors de la récupération des forêts par code", error);
        return null;
...
export async function  fetch_proprietaires_from_id_declarant (idDeclarant){
    try {
        const response = await apiRequest("GET", `api/degat_foret/proprietaire_from_id_declarant/${idDeclarant}`);
        return response;
    } catch (error) {
...
export async function  fetch_proprietaires_from_id(id_proprietaire) {
    try {
        const response = await apiRequest("GET", `api/degat_foret/proprietaire_from_id/${id_proprietaire}`);
        return response;
    } catch (error) {
...
export async function  fetch_areas_group_from_id_type(id_type_area) {
    ...
    try {
        const response = await apiRequest("GET", `api/ref_geo/areas_simples_from_type_code/l/${area_code}`);
        return response;
    } catch (error) {
...
export async function fetch_areas_child_of (id_area_parent, id_type_parent) {
    ...
    try {
        const response = await apiRequest("GET", `api/ref_geo/areas_child_of/${id_type_parent}/${id_area_parent}`);
        return response;
    } catch (error) {
...
export async function  fetch_areas_section_by_ids(idsSection) {
    ...
    try {
        const response = await apiRequest("GET", `api/ref_geo/areas_simples_from_type_code_container/l/OEASC_SECTION/${idsSection}`);
        return response;
    } catch (error) {
