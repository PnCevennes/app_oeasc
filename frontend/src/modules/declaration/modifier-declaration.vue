<template>
  <div style="margin: 40px; width: 100%;">
    ...
    <div>
      <div v-if="etape_affichage === 'AFFICHAGE_FORM'">
        <div v-if="initialized">
          <p>Besoin d'aide <help style="margin-left: 30px;">Personnes à contacter<tableAide></tableAide></help> </p>
          ...
          <v-form ref="form">
              ...
              <div>
                ...
                <h4>Status</h4>
                <div style="margin-top: 10px; border: 1px solid #ccc; padding: 20px; border-radius: 5px; ">
                  ...
                  <div style="display: flex; align-items: center;">
                    ...
                    >
                      ...
                      <v-radio label="Privée" :value="false"></v-radio>
                    </v-radio-group>
                  ...
                  <div style="display: flex; align-items: center;">
                    ...
                    <span v-if="declaration_data.b_statut_public">La forêt relève-t-elle du régime forestier ?</span>
                    <span v-else>La forêt est-elle dotée d'un document de gestion durable (plan simple de gestion ou code de bonnes pratiques sylvicoles) ?</span>
                    <span class="required">*</span>
              ...
              <v-fade-transition v-if="declaration_data.b_statut_public !== null && declaration_data.b_document !== null">
                <div>
                  ...
                  <div>
                      ...
                      <div style="width: 100%; position: relative;">
                            <MapDeclaration  :b_statut_public="declaration_data.b_statut_public" :b_document="declaration_data.b_document" :declaration_data="declaration_data"
                  ...
                  <div style="margin-top: 30px;"  v-if="declaration_data.b_document === false">
                    <h3>Informations sur la forêt</h3>
                    <div>
                      <p>Le nom de la forêt et sa superficie sont issues des données transmises par l’ONF. Ces informations ne peuvent être modifiées. Si vous constatez une erreur, merci de l’indiquer dans le cadre dédié aux commentaires libres en fin de formulaire ou de contacter l’animateur de l’Observatoire.</p>
                  ...
                  <div style="margin-top: 30px;" v-if="declaration_data.b_document === false">
                    ...
                    <p>Le nom de la forêt et sa superficie sont issues des données transmises par l’ONF. Ces informations ne peuvent être modifiées. Si vous constatez une erreur, merci de l’indiquer dans le cadre dédié aux commentaires libres en fin de formulaire ou de contacter l’animateur de l’Observatoire.
                      Veuillez cliquer sur « Suivant ».</p>

                      <div style="margin-top: 10px; border: 1px solid #ccc; padding: 20px; border-radius: 5px; display: flex; ">
                  ...
                  <div style="margin-top: 30px;">
                    ...
                    <div style="margin-top: 10px; border: 1px solid #ccc; padding: 20px; border-radius: 5px;">
                      ...
                      <div style="display: flex; flex-direction: row; padding-left: 20px; margin-top: 10px; width: 100%;">

                        <!-- ---- Origine des arbres: checkbox choix multiples (Rejet de souche, Régéneration naturelle, Plantation) ---- -->
                        <div style="display: flex; flex-direction: column; width: 30%;" >
                          <h5>Origine des arbres / plants / semis touchés <br> par les dégâts de grand gibier</h5>   
                          <v-checkbox
                            ...
                            :error="Array.isArray(declaration_data.nomenclatures_peuplement_origine2) && declaration_data.nomenclatures_peuplement_origine2.length === 0 && $refs.form && !$refs.form.valid"
                          ></v-checkbox>
                          <div v-if="Array.isArray(declaration_data.nomenclatures_peuplement_origine2) && declaration_data.nomenclatures_peuplement_origine2.length === 0 && $refs.form && !$refs.form.valid" style="color: red; font-size: 0.9em;">
                        ...
                        <div style="display: flex; flex-direction: column; margin-left: 20px; width: 30%;">
                          ...
                          <div>
                            <v-radio-group
                              ...
                              :rules="[rules.required]"
                              >
                              <div v-for="item in nomenclature.OEASC_PEUPLEMENT_TYPE.values" :key="item.id_nomenclature" style="display: flex; align-items: center;">
                                <v-radio
                                :label="item.label_fr"
                                :value="item.id_nomenclature"
                                ></v-radio>
                        ...
                        <div v-if="declaration_data.id_nomenclature_peuplement_type != 525"  style="display: flex; flex-direction: column; margin-left: 20px; width: 30%;">
                      ...
                      </div> <!-- fin de la ligne contenant les 3 formulaires "origine et structure"-->

                      <!-- ---- protection: bool radio oui/non ---- -->
                      <div>
                        <h4>Protection</h4>
                        <div style="display: flex; flex-direction: row; width: 100%; align-items: center; padding-left: 20px;">
                        ...
                        <div v-if="declaration_data.b_peuplement_protection_existence" style="padding-left: 40px; margin-top: -10px; margin-bottom: 20px;">
                            <div v-for="item in nomenclature.OEASC_PEUPLEMENT_PROTECTION_TYPE.values" :key="item.id_nomenclature">
                              <v-checkbox
                      ...
                      <div>
                        ...
                        <div v-if="declaration_data.b_peuplement_paturage_presence == true" style="padding-left: 20px;">
                          <div style="display: flex; flex-direction: row;">
                            ...
                            <div style="margin-left: 20px;">
                              <v-select
                                v-model="declaration_data.id_nomenclature_peuplement_paturage_frequence"
                            ...
                            <div v-if="declaration_data.id_nomenclature_peuplement_paturage_frequence == 547" style="margin-left: 20px;">
                              <v-select
                      ...
                      <div>
                        <h4>Accessibilité du peuplement
                          <help style="margin-left: 2em;">
                        ...
                        <div style="width: 100%;  padding-left: 20px;">
                          <v-radio-group
                            ...
                            row
                          >
                            <v-radio v-for="(item, index) in nomenclature.OEASC_PEUPLEMENT_ACCES.values" :key="index" :label="item.label_fr" :value="item.id_nomenclature"></v-radio>
                      ...
                      <div>
                        ...
                        <div style="width: 100%; padding-left: 20px;">
                          <h5>Espèces de grand gibier dont la présence est avérée (observations directes ou indices de présence)<span class="required">*</span></h5>
                          <v-select
                  ...
                  <div style="margin-top: 30px;">
                    ...
                    <div class="encadrer" style="padding-left: 20px;">
                  ...
                  <div style="margin-top: 30px;">
                    <h3>Commentaires</h3>
                    <div class="encadrer" style="padding-left: 20px;">
                      <p>Vous pouvez indiquer ici des informations complémentaires sur la déclaration, par exemple des précisions sur les dégâts constatés, les conditions de la forêt, etc.</p>
                      <v-textarea
                ...
                <!-- --------------------- Bouton de validation --------------------- -->
                  ...
                  <div style="margin-top: 30px; display: flex;">
                    <v-btn color="primary" @click="action_terminer_declaration">Terminer la déclaration</v-btn>
                  </div>
      ...
      <!-- <div v-if="initialized"> -->
        ...
        <div>
          ...
          <div>
            <p>J’autorise la transmission des informations fournies aux responsables cynégétiques locaux, pour pouvoir adapter la pression de chasse</p>
            <v-radio-group
          ...
          <div  v-if="this.$store.getters.droitMax >= 5" style="margin-top: 30px;">
          ...
          <div>
            <v-btn color="primary" @click="etape_affichage = 'AFFICHAGE_FORM'" style="margin-right: 30px;">Modifier la déclaration</v-btn>
            <v-btn color="success" @click="submitDeclaration">Soumettre la déclaration</v-btn>
          </div>
    ...
    <div style="position: fixed; bottom: 20px; left: 0; width: 100%; display: flex; justify-content: center; z-index: 9999;">
      <v-alert
      v-if="error"
      type="error"
      :value="showError"
    ...
    <div v-if="affichage_fenetre_succes" slot="success">
...
import {fetch_declaration_by_id,
  fetch_forets_from_code,
  fetch_proprietaires_from_id_declarant,
  fetch_proprietaires_from_id} from "./utils/api_request.js"; // Importez les fonctions nécessaires si elles existent
  ...
  watch: {
    ...
    "declaration_data.code_foret"(newVal, oldVal) {
      if (newVal && newVal !== oldVal && oldVal !== undefined) {
        ...
        fetch_forets_from_code(newVal).then((result) => {
          if (result && result.label_foret) {
            ...
            fetch_proprietaires_from_id(result.id_proprietaire).then((proprietaire) => {
              if (proprietaire) {
                this.declaration_data.nom_proprietaire = proprietaire.nom_proprietaire;
                this.declaration_data.adresse = proprietaire.adresse;
                this.declaration_data.s_commune_proprietaire = proprietaire.s_commune_proprietaire;
  ...
  methods: {
    ...
    async submitDeclaration() {
      ...
      if (!this.declaration_data || Object.keys(this.declaration_data).length === 0) {
        this.error = "Les données de la déclaration ne sont pas chargées. Veuillez réessayer plus tard.";
        return;
      }
    ...
    action_terminer_declaration() {
      ...
      if (this.declaration_data.b_document === false){
        ...
        if (!this.declaration_data.telephone) {
          this.error = "Le numéro de téléphone du propriétaire est requis si il n'y a pas de document de gestion.";
          return;
        }
        ...
        if (!this.declaration_data.surface_renseignee) {
          this.error = "La superficie renseignée est requise si il n'y a pas de document de gestion.";
          return;
        }


      }else{ // il y a un document de gestion
          if (this.declaration_data.b_statut_public == true
      ...
      if (this.declaration_data.b_peuplement_protection_existence == true
      ...
      if (this.declaration_data.b_peuplement_paturage_presence == true){
        if (this.declaration_data.nomenclatures_peuplement_paturage_type.length === 0
          || this.declaration_data.id_nomenclature_peuplement_paturage_statut === null
          || this.declaration_data.id_nomenclature_peuplement_paturage_frequence === null) {
          this.error = "Veuillez remplir tous les champs liés au pâturage.";
          return;
        }
        if (this.declaration_data.id_nomenclature_peuplement_paturage_frequence == 547
