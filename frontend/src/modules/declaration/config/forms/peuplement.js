...
export default {
  areas_localisation_cadastre: {
    ...
    condition: ({ baseModel }) =>
      ...
      (baseModel.areas_foret_dgd ||
        (baseModel.areas_foret_sections && baseModel.areas_foret_sections.length)),
    url: ({ baseModel }) =>
  ...
  nomenclatures_peuplement_maturite: {
    ...
    condition: ({ baseModel, $store }) => {
      const nomenclature = $store.getters.nomenclature(baseModel.id_nomenclature_peuplement_type);
  ...
  autre_protection: {
    ...
    condition: ({ baseModel, $store }) =>
      ...
      (baseModel.nomenclatures_peuplement_protection_type || []).find((id_nomenclature) => {
