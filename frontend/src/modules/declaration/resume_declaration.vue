...
<template v-if="bInit == true">
  <div>
    <v-simple-table dense style="margin-bottom: 16px; width: 70%; max-width: 100%; margin: auto;">
      ...
      <tbody>
        ...
        <tr v-if="declaration_data.id_nomenclature_proprietaire_type">
          ...
          <td class="droite">
            ...
            {{ foretType(get_nomenclature_to_string("OEASC_PROPRIETAIRE_TYPE", declaration_data.id_nomenclature_proprietaire_type))}}
          </td>
        </tr>
      ...
      <tbody>
          ...
          <tr v-if="declaration_data.id_nomenclature_peuplement_acces">
            ...
            <td class="droite">
              {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_ACCES", declaration_data.id_nomenclature_peuplement_acces) }}
            </td>
          </tr> 
      </tbody>
      ...
      <tbody>
        ...
        <tr v-if="declaration_data.id_nomenclature_peuplement_essence_principale">
          ...
          <td class="droite">
            {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_ESSENCE", declaration_data.id_nomenclature_peuplement_essence_principale) }}
        ...
        <tr v-if="declaration_data.nomenclatures_peuplement_essence_secondaire.length > 0">
          ...
          <td class="droite">
            {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_ESSENCE", declaration_data.nomenclatures_peuplement_essence_secondaire) }}
            </td>
        </tr>
        <tr v-if="declaration_data.nomenclatures_peuplement_essence_complementaire.length > 0">
          <td class="gauche">Complémentaire(s)</td>
          <td class="droite">
            {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_ESSENCE", declaration_data.nomenclatures_peuplement_essence_complementaire) }}
          </td>
        </tr>
      ...
      <tbody>
        ...
        <tr v-if="declaration_data.id_nomenclature_peuplement_origine">
          ...
          <td class="droite">
            {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_ORIGINE", declaration_data.id_nomenclature_peuplement_origine) }}
          </td>
        </tr>
        <tr v-if="declaration_data.nomenclatures_peuplement_origine2.length > 0">
          <td class="gauche">Origine des plants touchés</td>
          <td class="droite">
            {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_ORIGINE2", declaration_data.nomenclatures_peuplement_origine2) }}
            </td>
        </tr>
        <tr v-if="declaration_data.id_nomenclature_peuplement_type">
          <td class="gauche">Type</td>
          <td class="droite">
            {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_TYPE", declaration_data.id_nomenclature_peuplement_type) }}
            </td>
        </tr>
        <tr v-if="declaration_data.nomenclatures_peuplement_maturite.length > 0">
          <td class="gauche">Maturité</td>
          <td class="droite">
            {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_MATURITE", declaration_data.nomenclatures_peuplement_maturite) }}
          </td>
        </tr>
      ...
      <tbody>
        ...
        <tr v-if="declaration_data.nomenclatures_peuplement_protection_type.length > 0">
          <td class="gauche">Type</td>
          <td class="droite">
            {{get_nomenclature_to_string("OEASC_PEUPLEMENT_PROTECTION_TYPE", declaration_data.nomenclatures_peuplement_protection_type)}}
      ...
      <tbody>
        ...
        <template v-if="declaration_data.b_peuplement_paturage_presence == true">
          <tr v-if="declaration_data.nomenclatures_peuplement_paturage_type && declaration_data.nomenclatures_peuplement_paturage_type.length > 0">
            <td class="gauche">Type</td>
            <td class="droite">
              {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_PATURAGE_TYPE", declaration_data.nomenclatures_peuplement_paturage_type) }}
            </td>
          </tr>
          <tr v-if="declaration_data.id_nomenclature_peuplement_paturage_statut">
            <td class="gauche">Statut</td>
            <td class="droite">
              {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_PATURAGE_STATUT", declaration_data.id_nomenclature_peuplement_paturage_statut) }}
            </td>
          </tr>
          <tr v-if="declaration_data.id_nomenclature_peuplement_paturage_frequence">
            <td class="gauche">Fréquence</td>
            <td class="droite">
              {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_PATURAGE_FREQUENCE", declaration_data.id_nomenclature_peuplement_paturage_frequence) }}
            </td>
          </tr>
          <tr v-if="declaration_data.nomenclatures_peuplement_paturage_saison && declaration_data.nomenclatures_peuplement_paturage_saison.length > 0">
            <td class="gauche">Saison</td>
            <td class="droite">
              {{ get_nomenclature_to_string("OEASC_PEUPLEMENT_PATURAGE_SAISON", declaration_data.nomenclatures_peuplement_paturage_saison) }}
            </td>
          </tr>
        </template>
      </tbody>
      ...
      <tbody>
        ...
        <tr v-for="(item_degat, index) in declaration_data.degats" :key="index">
          <td class="gauche">{{get_nomenclature_to_string("OEASC_DEGAT_TYPE", item_degat.id_nomenclature_degat_type)}} </td>
          <td class="droite">
            ...
            <template v-if="item_degat.id_nomenclature_degat_type != 480">
              ...
              <template>
                <div v-for="(item_degat_essence, index_essence) in item_degat.degat_essences" :key="index_essence">
                  <strong>
                    {{get_nomenclature_to_string("OEASC_PEUPLEMENT_ESSENCE", item_degat_essence.id_nomenclature_degat_essence)}}
                  </strong>
                  ...
                  <span v-if="item_degat.id_nomenclature_degat_type != 479">
                    :
                    {{get_nomenclature_to_string("OEASC_DEGAT_ETENDUE", item_degat_essence.id_nomenclature_degat_etendue)}},
                    {{get_nomenclature_to_string("OEASC_DEGAT_GRAVITE", item_degat_essence.id_nomenclature_degat_gravite)}},
                    {{get_nomenclature_to_string("OEASC_DEGAT_ANTERIORITE", item_degat_essence.id_nomenclature_degat_anteriorite)}}
                  </span>
                 </div> 
              </template>
            </template>
