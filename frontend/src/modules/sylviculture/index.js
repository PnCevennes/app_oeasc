const ROUTE = [
  {
    name: 'sylviculture.restitution_diagnostics_sylvicoles',
    path: '/sylviculture/restitution_diagnostics_sylvicoles',
  ...
  },
  {
    ...
    path: '/sylviculture/restitution_suivi_peuplements_sensibles',
