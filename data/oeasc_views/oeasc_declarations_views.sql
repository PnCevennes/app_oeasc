...
CREATE OR REPLACE VIEW oeasc_declarations.v_export_declarations_csv AS
    SELECT 
        ...
        vd.peuplement_origine_mnemo AS "Origine peuplement",    
        vd.peuplement_origine2_mnemo AS "Origine plants touchés",    
        ...
        vd.commentaire AS "Commentaires",
...
CREATE OR REPLACE VIEW oeasc_declarations.v_export_declaration_degats_csv AS
    SELECT 
        ...
        ved."Secteur",
        ved."Peu. type",
        ved."Précision localisation",
        ved."Commentaires",
        ved."Origine peuplement",    
        ved."Origine plants touchés",    
        ved."Peu. mat.",
        ved."Ess. 1",
        ved."Ess. 2",
        ved."Pât. stat.",
