...
DELETE FROM oeasc_forets.t_proprietaires;

INSERT INTO oeasc_forets.t_proprietaires (id_nomenclature_proprietaire_type, nom_proprietaire, telephone, email, adresse, s_code_postal, s_commune_proprietaire)
...
SELECT  oeasc_forets.get_id_proprietaire_from_name(t.nom_proprietaire), true, true, l.area_code, l.area_name, l.label, l.surface_renseignee, l.surface_calculee
...
SELECT  l.id_area, f.id_foret
    FROM ref_geo.li_areas as l, oeasc_forets.t_forets as f
    WHERE id_type = ref_geo.get_id_type('OEASC_ONF_FRT')
...
INSERT INTO oeasc_forets.t_forets (
    id_proprietaire, b_statut_public, b_document, code_foret, nom_foret, label_foret, surface_renseignee, surface_calculee)
    SELECT oeasc_forets.get_id_proprietaire_from_name(p.nom_proprietaire), false, true, l.area_code, l.area_name, l.label, l.surface_renseignee, l.surface_calculee
        FROM oeasc_forets.t_proprietaires as p, ref_geo.temp_oeasc_dgd as d, ref_geo.li_areas as l
...
INSERT INTO oeasc_forets.cor_areas_forets(
     id_area, id_foret)
SELECT ref_geo.intersect_id_area_type_tol(l.id_area, 'OEASC_COMMUNE', 0.05), c.id_foret
    FROM oeasc_forets.cor_areas_forets as c, ref_geo.l_areas as l
