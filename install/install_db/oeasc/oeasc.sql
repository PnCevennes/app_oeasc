...
DROP TABLE IF EXISTS oeasc.cor_role_token;

CREATE TABLE IF NOT EXISTS oeasc.cor_role_token
(
...
DROP TABLE IF EXISTS oeasc.temp_users;

CREATE TABLE IF NOT EXISTS oeasc.temp_users
(
...
DROP TRIGGER IF EXISTS tri_modify_date_insert_temp_roles ON oeasc.temp_users;
