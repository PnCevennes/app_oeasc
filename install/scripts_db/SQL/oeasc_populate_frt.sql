...
COPY temp
    FROM '${ROOT_DIR}/app_oeasc/install/scripts_db/script_oeasc/liste_proprietaires_publics_oeasc.csv'
...
COPY temp
    FROM '${ROOT_DIR}/app_oeasc/install/scripts_db/script_oeasc/liens_proprietaires_publics_forets.csv'
    WITH DELIMITER ';' CSV QUOTE AS '''';
