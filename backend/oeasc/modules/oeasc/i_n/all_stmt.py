...
def stmt_results():
    ...
    stmt = (
        select(
            ...
            TRealisations.valide_coeur,
            TRealisations.valide_all,
            TRealisations.serie,
            ...
            TCircuits.km,
            TSecteurs.nom_secteur.label("ug"), # on devra le modifier par la suite pour différencier le causses gorgess coeur
            TEspeces.nom_espece,
        ...
        .join(TRealisations, TRealisations.id_realisation == TObservations.id_realisation)
