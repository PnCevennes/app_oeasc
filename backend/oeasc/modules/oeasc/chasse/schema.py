...
class TLieuTirSynonymesSchema(SQLAlchemyAutoSchema):
    ...
    lieu_tir_synonyme_display = fields.String (attribute="lieu_tir_synonyme_display", dump_only=True)
...
class VPlanChasseRealisationBilanSchema(SQLAlchemyAutoSchema):
    ...
    zone_cynegetique = Nested("TZoneCynegetiquesSchema", many=False, metadata={"load_instance": True})
    zone_indicative = Nested("TZoneIndicativesSchema", many=False, metadata={"load_instance": True})
