...
class ApiResponse:
    ...
    # -------------------------
    def add_log(self, message: str, type_log: str = "", with_timestamp: bool = False, with_user_info: bool = False):
    ...
    def write_in_log_file(self, filename=None, with_timestamp: bool = False):
        ...
        if not logger.handlers:
            if filename is None: # si le fichier n'est pas définie, on utilise celui enregistré à l'initialisation de l'objet ApiResponse
    ...
    # Ajouter une erreur
    # -------------------------
    def add_error(self, system_error: str, user_message: str = "", with_timestamp: bool = True, status_code: int = 400):
