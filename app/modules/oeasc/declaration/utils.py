...
# @TODO => IS USED ?  call by check_massif and utils_dict
...
# @TODO => IS USED ? call by random_populate
...
# @TOCLEAN NOT USED => utilisé par get_form_declaration
...
#         b_feuillus = b_feuillus and (
#             elem["cd_nomenclature"] != "AF"
#         )  # PeuplementEssence_AutresFeuillus
