L.Control.BetterScale = L.Control.extend({
    ...
    onAdd: function (t) {
        ...
        n = this.options,
        j = L.DomUtil.create("div", e + "-coeff", i),
    ...
    _updateMetric: function (t) {
        ...
        ? (e = a / 1000,
           ...
           r.innerHTML = o, h.innerHTML = i + "km")
        : (n = this._getRoundNum(a), s = this._getRoundNum(a / 2),
            l.style.width = this._getScaleWidth(n / a) + "px",
            r.innerHTML = s,
            h.innerHTML = n + "m")
        var w_ruler = $(ss).width()*0.0002645833;
        var coeff  = this._getRoundNum2(a/w_ruler);
        // var coeff  = Math.round(a/w_ruler);
        var c=coeff, d; // le nombre entier ou décimal (avec deux décimales au plus comme les montants monétaires) à écrire avec des espaces tous les trois chiffres
    ...
    _getRoundNum2: function (t) {
            var e = Math.pow(10, (Math.round(t) + "").length - 2),
            i = Math.round(t / e) * e;
            return i;
    },
});
