Requêtes pour retirer des erreurs dans l'ancienne table de l'oeasc. (Voir doc mise_en_production.md)
Si vous avez une bdd vierge et que vous avez effectué toutes les migrations, ce code est inutile.
